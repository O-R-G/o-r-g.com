...
class Objects extends Model
{
	...
	{
		// mysql 5.7.9 got very upset at me for this:
		// apparently when running a SELECT query as DISTINCT
		// (as get_all does) you have to select for everything you
		// order by (ie, because we are ordering by objects.rank, we
		// must select it).		
		$fields = array("*", "objects.id AS id");
		$tables = array("objects", "wires");
		$where	= array("wires.fromid = '".$o."'",
